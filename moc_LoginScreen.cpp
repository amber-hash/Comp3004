...
QT_MOC_LITERAL(5, 37, 14) // "onLoginClicked"

    },
    "LoginScreen\0loginSuccess\0\0User*\0user\0"
    "onLoginClicked"
};
...
void LoginScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loginSuccess((*reinterpret_cast< User*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (LoginScreen::*)(User * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginScreen::loginSuccess)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginScreen::loginSuccess(User * _t1)
{
